...
/*** Button Definitions *********************************************/
//      S1  is MCLR button
#define S3_PORT  PORTDbits.RD2
#define S6_PORT  PORTDbits.RD3
#define S5_PORT  PORTDbits.RD4       //Overlaps with D10
#define S4_PORT  PORTDbits.RD5

#define S3_TRIS  TRISDbits.TRISD2
#define S6_TRIS  TRISDbits.TRISD3
#define S5_TRIS  TRISDbits.TRISD4
