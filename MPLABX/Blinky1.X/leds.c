...
#define LED_D7_LAT      LATBbits.LATB4
#define LED_D8_LAT      LATBbits.LATB5
#define LED_D9_LAT      LATBbits.LATB6
#define LED_D10_LAT     LATBbits.LATB7      //Overlaps with S5
...
#define LED_D10_TRIS    TRISBbits.TRISB7    //Overlaps with S5
